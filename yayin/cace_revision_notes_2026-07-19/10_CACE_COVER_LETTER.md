...
The manuscript is relevant to the journal's scope in modeling and simulation, intelligent systems, and process monitoring. Its principal contribution is an integrated simulator-to-soft-sensor workflow for an inverse chemical-engineering problem, together with an explicit comparison of output constraints and ensemble strategies. The manuscript also states the limits of the simulation domain and the validation required before integration into model predictive control.

This manuscript has not been published previously and is not under consideration elsewhere. All authors have approved the submitted version. The authors declare no known competing financial interests or personal relationships that could have influenced the work.
