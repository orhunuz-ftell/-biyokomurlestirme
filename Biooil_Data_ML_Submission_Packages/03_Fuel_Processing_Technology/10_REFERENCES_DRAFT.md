# References Draft - Fuel Processing Technology Numbered Style

Fuel Processing Technology accepts any consistent style at submission but uses numbered references in text. Verify all records in a reference manager before upload.
